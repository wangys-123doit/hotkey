...
## 更新摘要
**变更内容**
- 新增Qoder、WorkBuddy、ONLYOFFICE、DingTalk等应用的热键支持
...
**更新** 本版本新增了对Qoder、WorkBuddy、ONLYOFFICE、DingTalk等应用的支持，以及标准用户权限启动功能，显著扩展了应用程序控制能力。
...
**更新** 本版本显著扩展了应用程序支持范围，新增Qoder、WorkBuddy、ONLYOFFICE、DingTalk等应用的热键支持，并实现了标准用户权限启动功能，为不同使用场景提供了更灵活的解决方案。
